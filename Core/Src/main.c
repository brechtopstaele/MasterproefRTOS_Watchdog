...
osThreadId checkUpdateTaskHandle;
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_StartCheckUpdateTask */
/**
* @brief Function implementing the checkUpdateTask thread.
* @param argument: Not used
* @retval None
*/
...
void StartCheckUpdateTask(void const * argument)
{
  ...
  /* USER CODE END StartCheckUpdateTask */
}
